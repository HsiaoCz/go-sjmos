...
比如说我们制作一杯饮料，一般有固定的流程
将固定的流程事包装成模板

### 2、命令模式

假如说去医院看医生这件事情,我们让病人填写病单
让医生凭病单治病

这时候，病人和病单依赖，医生和病单依赖 可以实现医生病人的解耦
还可以添加一层护士层，病人将病情告诉护士，护士统计病单
护士将病单批量发送给医生
...
观察者模式：比如开车，看到红绿灯，不同的对象看到红绿灯做出的反应是不同的
这里可以把车辆作为观察者，交通信号灯作为观察目标

反过来说：信号灯是通知者，而车辆就是被通知者